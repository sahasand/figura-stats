...
const EXTRA_PACKAGES = { km: ["survival", "survminer"], roc: ["pROC"] };
...
async function boot() {
  ...
  for (const f of ["dispatch.R", "forest.R", "consort.R", "table1.R", "km.R", "groupcompare.R", "correlation.R", "roc.R", "themes.R"]) {
